...
class Player2(Player):
    ...
    def __init__(self, x_pos, y_pos):
        ...
        default_idle_list = []
        for i in range(5):
            img = pygame.image.load(f"Gunner_Yellow_Sprites/Gunner_Yellow_Idle/Gunner_Yellow_Idle{i}.png")
        ...
        default_run_list = []
        for i in range(6):
            img = pygame.image.load(f"Gunner_Yellow_Sprites/Gunner_Yellow_Run/Gunner_Yellow_Run{i}.png")
            img = pygame.transform.scale(img, (70, 85))
        ...
        default_jump_list = []
        for i in range(2):
            img = pygame.image.load(f"Gunner_Yellow_Sprites/Gunner_Yellow_Jump/Gunner_Yellow_Jump{i}.png")
            img = pygame.transform.scale(img, (70, 85))
        ...
        riffle_idle_list = []
        for i in range(5):
            img = pygame.image.load(f"Riffle_Yellow_Sprites/Riffle_Yellow_Idle/Riffle_Yellow_Idle{i}.png")
        ...
        riffle_run_list = []
        for i in range(6):
            img = pygame.image.load(f"Riffle_Yellow_Sprites/Riffle_Yellow_Run/Riffle_Yellow_Run{i}.png")
            img = pygame.transform.scale(img, (84, 85))
        ...
        riffle_jump_list = []
        for i in range(2):
            img = pygame.image.load(f"Riffle_Yellow_Sprites/Riffle_Yellow_Jump/Riffle_Yellow_Jump{i}.png")
            img = pygame.transform.scale(img, (84, 85))
        ...
        sniper_idle_list = []
        for i in range(5):
            img = pygame.image.load(f"Sniper_Yellow_Sprites/Sniper_Yellow_Idle/Sniper_Yellow_Idle{i}.png")
        ...
        sniper_run_list = []
        for i in range(6):
            img = pygame.image.load(f"Sniper_Yellow_Sprites/Sniper_Yellow_Run/Sniper_Yellow_Run{i}.png")
            img = pygame.transform.scale(img, (118, 85))
        ...
        sniper_jump_list = []
        for i in range(2):
            img = pygame.image.load(f"Sniper_Yellow_Sprites/Sniper_Yellow_Jump/Sniper_Yellow_Jump{i}.png")
            img = pygame.transform.scale(img, (118, 85))
        ...
        canon_idle_list = []
        for i in range(5):
            img = pygame.image.load(f"Canon_Yellow_Sprites/Canon_Yellow_Idle/Canon_Yellow_Idle{i}.png")
        ...
        canon_run_list = []
        for i in range(6):
            img = pygame.image.load(f"Canon_Yellow_Sprites/Canon_Yellow_Run/Canon_Yellow_Run{i}.png")
            img = pygame.transform.scale(img, (106, 85))
        ...
        canon_jump_list = []
        for i in range(2):
            img = pygame.image.load(f"Canon_Yellow_Sprites/Canon_Yellow_Jump/Canon_Yellow_Jump{i}.png")
            img = pygame.transform.scale(img, (106, 85))
        ...
        scatter_idle_list = []
        for i in range(5):
            img = pygame.image.load(f"Scatter_Yellow_Sprites/Scatter_Yellow_Idle/Scatter_Yellow_Idle{i}.png")
        ...
        scatter_run_list = []
        for i in range(6):
            img = pygame.image.load(f"Scatter_Yellow_Sprites/Scatter_Yellow_Run/Scatter_Yellow_Run{i}.png")
            img = pygame.transform.scale(img, (86, 85))
        ...
        scatter_jump_list = []
        for i in range(2):
            img = pygame.image.load(f"Scatter_Yellow_Sprites/Scatter_Yellow_Jump/Scatter_Yellow_Jump{i}.png")
            img = pygame.transform.scale(img, (86, 85))
    ...
    def display_total_lives(self, screen):
        ...
        for i in range(1, self.total_lives+1):
            screen.blit(lives_img, (30*i+1130, 20))
    ...
    def display_grenade_numbers(self, screen):
        ...
        for i in range(1, self.grenade_total + 1):
            screen.blit(grenade_img, (20 * i + 1270, 70))
    ...
    def display_jumping_times(self, screen):
        ...
        screen.blit(jump_message, (1340, 10))
